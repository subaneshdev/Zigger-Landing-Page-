              ...
              {currentPost ? (
                <div>
                  ...
                  <div style={{ 
                        ...
                        return (
                          <div key={bIdx} style={{
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                              <img 
                                alt="Ziggers" 
                                src="https://ph-files.imgix.net/6921a2d6-7892-4b0a-954f-f74b7a7ac5d1.x-icon?auto=compress,format&codec=mozjpeg&cs=strip&fit=crop&h=80&w=80" 
                                style={{ width: '64px', height: '64px', borderRadius: '8px', objectFit: 'cover', flexShrink: 0 }} 
                              />
                              <div style={{ flex: '1 1 0%', minWidth: '0px' }}>
                                <h3 style={{ margin: '0px', fontSize: '18px', fontWeight: 600, color: 'rgb(26, 26, 26)', lineHeight: 1.3, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>Ziggers</h3>
                                <p style={{ margin: '4px 0px 0px', fontSize: '14px', color: 'rgb(102, 102, 102)', lineHeight: 1.4, overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical' }}>
                                  India's marketplace for flexible local work.
                                </p>
                              </div>
                            </div>
                            <a 
                              href="https://www.producthunt.com/products/ziggers?embed=true&utm_source=embed&utm_medium=post_embed" 
                              target="_blank" 
                    ...
                    {/* Product Hunt Launch Embed Card */}
                    <div style={{
                      fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif',
                      border: '1px solid rgb(224, 224, 224)',
                      borderRadius: '12px',
