...
export const SEO_CATEGORIES = [
  ...
  {
    slug: 'catering-boys',
    primaryKeyword: 'Catering Boys',
    hireKeyword: 'Hire Catering Boys',
    role: 'catering boys and event servers',
    workerTerms: ['Catering Boys', 'Catering Jobs', 'Part-time Catering Boys', 'Event Boys Jobs', 'Daily Wage Catering'],
    employerTerms: ['Catering Boys', 'Hire Catering Boys', 'Catering Service Boys', 'Catering Boys for Weddings', 'Event Catering Boys'],
    workLink: '/work',
    hireLink: '/hire',
  },
  {
    slug: 'catering-workers',
    primaryKeyword: 'Catering Workers',
    hireKeyword: 'Hire Catering Workers',
    role: 'catering workers and kitchen helpers',
    workerTerms: ['Catering Workers', 'Catering Helper Jobs', 'Kitchen Helper Jobs', 'Banquet Staff Jobs', 'Catering Jobs'],
    employerTerms: ['Catering Workers', 'Hire Catering Workers', 'Catering Helpers', 'Restaurant Kitchen Helpers', 'Wedding Catering Staff'],
    workLink: '/work',
    hireLink: '/hire',
  },
  {
